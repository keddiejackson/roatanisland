...
test("guest trip plan upgrade is wired through map, account, admin, and SQL", () => {
  ...
  assert.match(tripPlansApiSource, /concierge_lead_id/);
  assert.match(tripPlansApiSource, /hydrateTripPlanStatuses/);
  assert.match(tripPlanConciergeApiSource, /legacyTripPlanSelect/);
  assert.match(tripPlanConciergeApiSource, /legacyTripPlanSelect/);
  assert.match(tripPlanConciergeApiSource, /concierge_lead_id/);
