...
test("homepage uses premium Framer Motion travel-marketplace animations", () => {
  ...
  const listingCardSource = readProjectFile("app/HomeListingCard.tsx");
  ...
  assert.match(listingCardSource, /listingCardVariants/);
  assert.match(listingCardSource, /viewport=\{\{ once: true/);
});
