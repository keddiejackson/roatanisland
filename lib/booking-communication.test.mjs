...
test("summarizes drawer threads for floating button counts", () => {
  assert.deepEqual(
    bookingDrawerStats([
      { messageCount: 2, internalCount: 0, lastMessagePreview: "", lastSenderRole: "guest", badgeLabel: "Needs response", needsResponse: true },
      { messageCount: 1, internalCount: 1, lastMessagePreview: "", lastSenderRole: "vendor", badgeLabel: "Updated", needsResponse: false },
    ]),
    {
      threadCount: 2,
